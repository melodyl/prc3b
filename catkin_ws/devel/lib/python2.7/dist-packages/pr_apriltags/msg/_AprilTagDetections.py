...
"""autogenerated by genpy from pr_apriltags/AprilTagDetections.msg. Do not edit."""
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','pr_apriltags/AprilTagDetection[]']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.detections:
        ...
        buff.write(_struct_f.pack(val1.tag_size))
        _v3 = val1.pose
        _v4 = _v3.position
        _x = _v4
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = pr_apriltags.msg.AprilTagDetection()
        _v6 = val1.header
        start = end
        end += 4
        ...
        (val1.tag_size,) = _struct_f.unpack(str[start:end])
        _v8 = val1.pose
        _v9 = _v8.position
        _x = _v9
        start = end
