...
(cl:defclass <AprilTagDetections> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (detections
    :reader detections
    :initarg :detections
    :type (cl:vector pr_apriltags-msg:AprilTagDetection)
   :initform (cl:make-array 0 :element-type 'pr_apriltags-msg:AprilTagDetection :initial-element (cl:make-instance 'pr_apriltags-msg:AprilTagDetection))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <AprilTagDetections>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AprilTagDetections)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr_apriltags-msg:<AprilTagDetections> is deprecated: use pr_apriltags-msg:AprilTagDetections instead.")))
...
(cl:defmethod detections-val ((m <AprilTagDetections>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr_apriltags-msg:detections-val is deprecated.  Use pr_apriltags-msg:detections instead.")
  (detections m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <AprilTagDetections>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'detections)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'pr_apriltags-msg:AprilTagDetection))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AprilTagDetections>)))
  ...
  "pr_apriltags/AprilTagDetections")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AprilTagDetections)))
  "Returns string type for a message object of type 'AprilTagDetections"
  "pr_apriltags/AprilTagDetections")
